...
export const CommandPalette: React.FC<CommandPaletteProps> = ({
  ...
  const quickActions = [
    {
      id: 'action-download',
      labelTr: 'ZenDev v2.4.3 Yükleyiciyi İndir',
      labelEn: 'Download ZenDev v2.4.3 Installer',
      icon: Download,
      href: '#download'
    },
    {
      ...
      >
        ...
        <div className="p-4 border-b border-gray-800 flex items-center gap-3 bg-[#070914]">
          ...
          <input
            ...
            placeholder={
              lang === 'tr'
                ? '27+ araç veya aksiyon ara (örn: sqlite, port, sha256)...'
                : 'Search 27+ tools or actions (e.g., sqlite, port, sha256)...'
            }
