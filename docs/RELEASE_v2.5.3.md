# ZenDev Release v2.5.3

Version 2.5.3 synchronizes all release manifests, website download helpers, test suites, and repository configurations.

## Changes
- Bump version from 2.5.2 to 2.5.3 across root, desktop core, and website packages.
