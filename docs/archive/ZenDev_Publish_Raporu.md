# 💎 ZenDev v2.4.0 - Production Derleme ve Dağıtım Raporu
...
| :--- | :--- | :--- | :--- |
| **Windows Setup (.exe)** | `C:\Users\futbo\Desktop\AI Projeleri\NexusHub\dist\ZenDev-Setup-2.4.0.exe` | **~202 MB (Universal Installer)** (212,783,533 bayt (Universal x64 + ARM64)) | Son kullanıcı için NSIS tabanlı tek tıkla kurulum paketi. Masaüstü & Başlat menüsü kısayolu oluşturur. |
...
| **Blockmap Dosyası** | `C:\Users\futbo\Desktop\AI Projeleri\NexusHub\dist\ZenDev-Setup-2.4.0.exe.blockmap` | 103 KB | Electron-updater diferansiyel güncelleme haritası. |
...
1. `C:\Users\futbo\Desktop\AI Projeleri\NexusHub\dist\ZenDev-Setup-2.4.0.exe` dosyasını test amaçlı sanal makinede veya kendi bilgisayarınızda çalıştırarak kurulumu deneyimleyebilirsiniz.
